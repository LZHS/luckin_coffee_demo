              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    width: double.infinity,
                    height: 44.0,
                    margin: EdgeInsets.only(left: 38.0, right: 38.0, top: 25.0),
                    child: Ink(
                      decoration: BoxDecoration(
...
goPhoneCode(){
  Log.d("手机验证码登录");
  Application.router.navigateTo(context, loginPhoneCode+"?isDeficiencyNum=false",transition: TransitionType.inFromLeft);
}
  goWeChatLogin() {
    Log.d("跳转至为微信登录页面");
  }
