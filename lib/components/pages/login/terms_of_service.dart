...
class _TermsOfServiceState extends State<TermsOfService> {
  final TextStyle _textStyle =
      TextStyle(color: Color(0xff383838), fontSize: 14.0);
  final contextStr = """尊敬的客户，在您下载luckin coffee程序( 下称“APP")使用我们的服务前，请仔细阅读本用户协议。
用户协议
本协议是您与瑞幸咖啡(北京)有限公司(以下简称“瑞幸咖啡”)签署的《用户协议》。您下载本APP并成功注册后，即被视为已阅读、理解、接受本协议条款。本协议可由我们不时作出修订，且构成您与我们之间达成的有关APP使用、具有约束力的协议。您在修订发布后继续使用APP，即视为您已接受了相关修订。如果您不同意本协议或相关修订，则应立即卸载本APP。如果您不满十八(18) 周岁，您应确保与您的父母或监护人共同阅读本协议，以便您及您的父母或监护人理解并同意本协议的内容。
1.用户许可
...
志")未经瑞幸咖啡或相关商标持有人的事先书面许可，用户不得全部或部分地复制、模仿或使用瑞幸咖啡标志或第三方标志。APP和内容受到与著作权、商标、专利、商业秘密及其他专有权利相关的国际条约、法律、法规、行政规章等规定的保护，您可在瑞幸咖啡或内容所有人授权的情况下使用包含保护数字信息的安全组件。
6.合约期限及变更、终止
...
""";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: HeadTitleBar(title: "用户协议"),
      body: SafeArea(
        child: Padding(
